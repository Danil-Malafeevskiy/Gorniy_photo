 ...
 */
final class Version20211119103609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE relation_album_and_image (id INT NOT NULL, id_image_id INT DEFAULT NULL, id_album_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE relation_album_and_image ADD CONSTRAINT FK_18CE0E036D7EC9F8 FOREIGN KEY (id_image_id) REFERENCES img (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
